...
set -x PYTORCH_CUDA_ALLOC_CONF max_split_size_mb:512
...
set -a PATH ~/st/stm32cubeide_1.11.2/
set -a PATH /opt/google-cloud-cli/bin/

set -p GOPATH /home/tom/Projects/aitools/
set -a PATH $GOPATH
